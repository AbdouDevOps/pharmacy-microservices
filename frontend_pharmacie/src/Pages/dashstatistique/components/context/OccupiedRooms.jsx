    ...
    <div className="p-6">
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
        <div className="flex items-center mb-4">
          <People className="text-orange-500 text-3xl" />
          <h4 className="text-xl font-medium ml-3">Occupied Rooms</h4>
        </div>
        <p className="text-2xl font-semibold">
          {occupiedChambres || "Donnée non disponible"}
        </p>
        <div className="mt-4">
          <ReactApexChart
            options={{
