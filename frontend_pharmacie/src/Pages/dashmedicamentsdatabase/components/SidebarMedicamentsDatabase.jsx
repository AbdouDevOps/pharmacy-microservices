...
import { AccountBalance, BarChartOutlined, Domain, Engineering, Error, Group, Inventory, Message, SettingsSuggest, Vaccines, Warning, WarningAmber } from "@mui/icons-material";
...
export default function SidebarUpdateProf() {
  ...
  // i want a function that required a boolean variable
      ...
      <Sheet
        ...
        <Box
          ...
          <List
            ...
            <ListItem>
              <ListItemButton component={Link} to="/dashMedicamentsDatabase" selected >
