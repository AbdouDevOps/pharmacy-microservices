...
import SidebarMedicament from "./components/SidebarMedicament.jsx";
import HeaderMedicament from "./components/HeaderMedicament.tsx";
...
export default function dashMedicament() {
  return (
